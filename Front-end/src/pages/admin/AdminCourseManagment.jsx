...
function AdminCourseManagement() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const [coursesResponse, facultiesResponse, departmentsResponse] =
          await Promise.all([
            fetch("http://localhost:8080/api/courses_with_departments"),
  ...
  return (
    <>
      <PageTitle title={"Admin Course Management - SmartEduDocs"} />
      <div className="flex flex-col h-full">
        ...
        {filteredCourses.length != 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-col-3 gap-4 flex-1 overflow-y-auto scrollbar-thin md:pr-4 pr-2">
